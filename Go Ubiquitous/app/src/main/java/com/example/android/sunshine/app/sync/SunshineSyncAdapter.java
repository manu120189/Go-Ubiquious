...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
        ...
        if ( displayNotifications ) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    sendNotificationToWearable(context, high, low, iconId);
    ...
    private void sendNotificationToWearable(Context context, double high, double low, int iconId) {
        try{
            //Send information to wearable
            SunshineSyncService sunshineSyncService = (SunshineSyncService) getContext();

            sunshineSyncService.sendWearableRequest(
                    SunshineSyncService.WEATHER_KEY,
                    SunshineSyncService.WEATHER_ICON_KEY,
                    iconId,
                    Utility.formatTemperature(context, high) + "," + Utility.formatTemperature(context, low));
        }catch (Exception e){
            Log.e("SunshineSyncAdapter", e.getLocalizedMessage());
        }
    }
